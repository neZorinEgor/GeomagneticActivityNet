...
На графиках представлено сравнение предсказанных (оранжевый) и фактических (синий) значений индексов `Dst` и `AE` за 2019 год

| Dst прогноз | AE прогноз |
|-------------|-------------|
| ![Dst](asserts/dst_result.png) | ![AE](asserts/ae_result.png) |
